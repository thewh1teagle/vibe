...
export default function Logo({ className }: { className?: string }) {
	...
	const badge = `logo-badge-${uid}`
	const ink = `logo-ink-${uid}`
	const gold = `logo-gold-${uid}`

	return (
		<svg viewBox="0 0 169 169" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn('size-8 shrink-0', className)} aria-hidden="true">
			<defs>
