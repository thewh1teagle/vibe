...
const EC_CODEWORDS_PER_BLOCK = [
	-1, 7, 10, 15, 20, 26, 18, 20, 24, 30, 18, 20, 24, 26, 30, 22, 24, 28, 30, 28, 28, 28, 28, 30, 30, 26, 28, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30,
	30, 30,
]
const EC_BLOCKS = [-1, 1, 1, 1, 1, 1, 2, 2, 2, 2, 4, 4, 4, 4, 4, 6, 6, 6, 6, 7, 8, 8, 9, 9, 10, 12, 12, 12, 13, 14, 15, 16, 17, 18, 19, 19, 20, 21, 22, 24, 25]
...
/**
 * Centres of the alignment patterns, evenly spaced between the two outer ones.
 * The spacing is rounded up to an even number — one extra `/ 2` here puts every
 * pattern from version 7 on in the wrong place, and nothing can read the result.
 */
