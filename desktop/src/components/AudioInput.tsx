...
export default function AudioInput({ onChange }: { onChange: (path: string) => void }) {
  ...
  return (
    <div
      ...
      className="flex-row cursor-pointer h-10 shadow-lg flex justify-between items-center bg-base-200 rounded-lg w-[100%] m-auto px-3 my-3 select-none">
      <p>{name?.split("\\").pop()}</p>
